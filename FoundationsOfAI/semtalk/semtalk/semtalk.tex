...
\begin{itemize}
\item Markov Decision Processes as framework no longer sufficient in most cases $\rightarrow$ Markov Games as a new framework
...
\begin{itemize}
\item \textcolor{red}{Fully cooperative tasks}: All agents have the same goal\\
Example: Explore the world most efficiently
\item \textcolor{red}{Fully competitive tasks}: Agents have an opposite goal (try to minimize the reward of the other agent)\\
Example: Try to win against the agents of the other team in robot soccer
\item \textcolor{red}{Mixed tasks}: Agents cooperate, but also act in an egoistic way\\
...
\item Additional problem: Q tables may become very large (all combinations of actions of the agents have to be considered)
\end{itemize}
\end{frame}
\begin{frame}
...
\begin{itemize}
\item Minimax-Q is insensitve against the opponent against which it was trained
\item Minimax assumption not good against non-optimal opponents
